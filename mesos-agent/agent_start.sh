...
#./bin/mesos-agent.sh --master=10.103.0.125:5050	\
...
ACHIEVE_DOCKER_IAMGES_DIR="/home/sunzhe/workspace/docker-images"

./bin/mesos-agent.sh --master=zk://${MESOS_MASTER_IP}:2181/mesos	\
										 --ip=10.103.0.125	\
